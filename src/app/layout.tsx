...
export const metadata: Metadata = {
  title: "SaaS Platform - Grow Your Business Faster",
  description: "Powerful SaaS tools for analytics, security, and integrations. Try free for 14 days. Used by 50K+ teams worldwide.",
  keywords: "SaaS, business analytics, cloud software, integration platform, enterprise tools",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    ...
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763829847865-hng34twc.jpg",
  ...
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763829847865-hng34twc.jpg"]
  }
};
